...
module.exports = {
    name: 'grab',
    description: 'Grab the current song (same as save)',
    aliases: ['gr'],
    category: 'music',
    premium: false,
    player: true,
    ...
    async execute(client, message, args, prefix) {
        ...
        const savedEmbed = new EmbedBuilder()
            .setColor(config.embedColor)
            .setTitle(`${emojis.music} Grabbed Track`)
            ...
            .setFooter({ text: `Grabbed from ${message.guild.name}` })
            .setTimestamp();
        ...
        try {
            ...
            const confirmEmbed = new EmbedBuilder()
                .setColor(config.embedColor)
                .setDescription(`${emojis.success} Successfully grabbed the current song to your DMs!`);
    ...
    async interactExecute(client, interaction) {
        ...
        const savedEmbed = new EmbedBuilder()
            ...
            .setThumbnail(track.thumbnail)
            .setFooter({ text: `Grabbed from ${interaction.guild.name}` })
            .setTimestamp();
